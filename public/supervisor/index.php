<?php
    ...
    $teamApplications =  $employeeRecord->getAllTeamApplication($_SESSION['department'], $employeetype, $status);
                    ...
                    for($i = 0; $i < count($getleaveapplication); $i++){
                        ...
                        <tr>
                            ...
                            <?php if($getleaveapplication[$i]['status'] == 'Pending'){ 
                                echo "<td><span id='status' class='pending'>". $getleaveapplication[$i]['status'] ."</span>
                                ...
                                echo "<td><span id='status' class='approved'>". $getleaveapplication[$i]['status'] ."</span>
                                <i class='fas fa-times h5' style='color:#D0312D;'></i>
                                </td>";
                            } else if($getleaveapplication[$i]['status'] == 'Approved' && $getleaveapplication[$i]['hr_attend'] == 'yes') {
                                echo "<td><span id='status' class='approved'>". $getleaveapplication[$i]['status'] ."</span>
                                <i class='fas fa-check h5' style='color:#198754;'></i>
                                </td>";
                            }
                             else if($getleaveapplication[$i]['status'] == 'Declined'){
                                echo "<td><span id='status' class='declined'>". $getleaveapplication[$i]['status'] ."</span>
                                <i class='fas fa-times h5' style='color:#D0312D;'></i>
                                </td>";
                            }
                            echo 
                ...
                if(!empty($teamApplications)){
                    for($i = 0; $i < count($teamApplications); $i++){
                        ...
                        <tr>
                            ...
                            <td><span id='status' class='pending'>". $teamApplications[$i]['status'] ."<span></td>
